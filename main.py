...
async def guild_save(request: Request, guild_id: str):
    ...
    _all_cmds = [
        ...
        "sugerencia","confesar","cumpleaños","postular","streamer","gemdrop",
        "sticky","media","tempvoice","hilo","embed",
        "jail","unjail","warn","mute","unmute","kick","ban","purge","lock","unlock","slowmode","snipe",
        "autorole","selfroles","rr",
        "welcome","boost","avatares","userinfo","serverinfo","banner",
        "daily","work","bal","pay","shop","buy","rank","levels",
        "ticket","close","add","remove","claim",
        "play","skip","stop","pause","resume","queue","nowplaying","volume","music",
        "ship","hug","kiss","slap","pat","meme","nsfw",
        "antiraid","automod","verify","logs",
    ]
    _disabled = []
    for _c in _all_cmds:
